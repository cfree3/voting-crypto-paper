...
of the Scantegrity system: Tables P, Q, R, and S (see ~\ref{fig:scantegrity}).
...
\pv\ accomplishes this process via a \term{mixnet}: a set of mix servers each secretly shuffle and transform, in turn, the set of encrypted votes in a verifiable way. Scratch \& Vote \cite{scratch}, a variation on \pv, tallies the votes homomorphically rather than with a mixnet.
